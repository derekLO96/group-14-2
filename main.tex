...
\begin{itemize}
	\item Meeting 1: 11/08/25:
	Overall, this meeting established our foundation and expectations for how we will operate as a group moving forward. 
...
checking calculations—gave us a structure that will guide our next sessions and ensured that each member feels supported.
	...
	\item \paragraph{Meeting 2: 12/01/25: In this meeting we talked about summations and we worked through a couple of different problemes regarding 
summations. We first began by going through some question through the website FEPrep.net while checking class notes and the professor's 
notes on the COP website.
...
\begin{itemize}
	...
	\item: \paragraph{Collaborative Problem-Solving: We discovered that brainstorming sessions yielded more innovative solutions when everyone shared their perspectives openly.}
\end{itemize}

%--------------------------------------------------------------------------------------------------------------------------------
\section{Member's Reflection}
\subsection{Derek Lopes Oliveira}
\paragraph{AT first I was sent to a group who didn't really talk apart from three different ocassions. I was thinking that this was a failed experiment and all my hope was lost on this project.
Luckily, just before decemeber started, I was transfered to the hardworking group that I am now and I trully understand the purpose of this excercise. Together we worked through problemas and overcame
challenges that we would otherwise not have solved it on our own. The collaboration with this team has showed me the possibilities of team work going into my field of computer science and hope 
to one day have a great team like this one again. }
